...
function validateOptions(options) {
  const { ACCESS_TOKEN, COOKIE, COURSES, ID_RS_INIT } = options;
  if (!ACCESS_TOKEN || !COOKIE || !COURSES || !ID_RS_INIT) {
    throw new Error('Thiếu biến môi trường. Kiểm tra lại file .env hoặc nhập đủ thông tin trong GUI.');
  }
}
